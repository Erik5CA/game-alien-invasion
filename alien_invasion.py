...
class AlienInvasion:
    ...
    def __init__(self):
        """Initializes the game, and create game resourses"""
        pygame.init()
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # If so, get rid of eht bullet and the alien
        ...
        if not self.aliens:
            # Destroy existing bullets and create a new flet.
            self.bullets.empty()
            self._create_fleet()
    ...
    def _update_aliens(self):
        """Check if the fleet is at an edge,then update the position of all alines in the fleet"""
    ...
    def _create_fleet(self):
        ...
        while current_y < (self.settings.screen_height - 3 * alien_heigth):
            ...
            # Finished a row; reset x value and incremetn y value.
    ...
    def _update_screen(self):
        ...
        # Draw the play button if game is active.
